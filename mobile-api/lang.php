    ...
    function mobile_t($key, $lang = null) {
        ...
        $translations = [
            'en' => [
                ...
                'history.archive_title' => 'Archived orders',
                'history.all' => 'All',
                'history.filter_month' => 'Filter by month',
                'history.loading' => 'Loading archive…',
                'history.load_more' => 'Load more',
                'history.end' => 'End of archive',
                'history.summary' => 'Showing {loaded} of {total}',
                'history.error' => 'Could not load archive. Please try again.',
                'confirm' => 'Confirm',
                'barcode' => 'Barcode',
                'awb' => 'AWB',
            ...
            'ar' => [
                ...
                'history.archive_title' => 'الطلبات المؤرشفة',
                'history.all' => 'الكل',
                'history.filter_month' => 'تصفية حسب الشهر',
                'history.loading' => 'جاري تحميل الأرشيف…',
                'history.load_more' => 'تحميل المزيد',
                'history.end' => 'نهاية الأرشيف',
                'history.summary' => 'عرض {loaded} من {total}',
                'history.error' => 'تعذر تحميل الأرشيف. حاول مرة أخرى.',
                'confirm' => 'تأكيد',
                'barcode' => 'الباركود',
                'awb' => 'رقم الشحنة',
